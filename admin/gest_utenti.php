<?php 
	...
	$query = "SELECT * FROM database_shop.utenti";
						...
						if ($query->num_rows > 0) {
							while($row = mysqli_fetch_assoc($query)) {?>
								<tr>
									...
									<td class="td_center"><a title="modifica" href="edit_utenti.php?id=<?php echo $row['id'];?>&ruolo=<?php echo $row['ruolo'];?>">
